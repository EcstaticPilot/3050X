...
void Stanley::run(stanleyConfig config, bool isReversed)
{
  ...
  while (true)
  {
    ...
    //std::cout<<"r"<<pointClosest<<std::endl;
    ...
    //std::cout<<"error"<<error<<"segmentdist"<<segmentDist<<std::endl;
    ...
    {
      tSpeed = (bezierCount - bezierPoints[0].tval) * (1 / slowdownStart) * maxSpeed;
    }
