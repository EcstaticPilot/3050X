...
Auton selectedAuton = defensizeZoneRush;
...
void onScreenPress()
{
    ...
    if (blue3.checkTouch())
        selectedAuton = offensiveZoneRush;
    if (re          d3.checkTo                             uch())
        selectedAuton = offensiveZoneRush;  
    if(red4.checkTouch())
        selectedAuton = defensizeZoneRush;
    if(blue4.checkTouch())
        selectedAuton = defensizeZoneRush;
...
void initializeAutonSelector(void)
{
    ...
    red1 = button(70, 190, 40, 40, red, "1");
    red2 = button(228, 190, 40, 40, red, "2");
    red3 = button(278, 190, 40, 40, red, "rush");
    red4 = button(120, 190, 40, 40, red, "rush");

    blue1 = button(70, 0, 40, 40, blue, "1");
    blue2 = button(228, 0, 40, 40, blue, "2");
    blue3 = button(120, 0, 40, 40, blue, "rush");
    blue4 = button(278, 0, 40, 40, blue, "rush");
