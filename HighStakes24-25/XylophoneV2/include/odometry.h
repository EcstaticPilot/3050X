...
{
private:
  static const double distFromCenterL = 6;
  static const double distFromCenterB = 1;
  static const double lRad = 1.625;
  static const double rRad = 1.625; // radius of tracking wheel
  static const double bRad = 1.375; // radius of tracking wheel
