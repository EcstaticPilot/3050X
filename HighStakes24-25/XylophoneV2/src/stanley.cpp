 ...
 * @brief add event
 *
 * @param funcptr function to run
 * @param tval tvalue to run the function
 */
...
/**
 * @brief set the path for the stanley controller
 * 
 * @param controlPointsi 
 */
...
/**
 * @brief run the currently set path
 * 
 * @param config slow, meduim, fast
 * @param isReversed whether the robot is reversed or not
 */
void Stanley::run(stanleyConfig config, bool isReversed)
{
  ...
  while (true)
  {
    ...
    //std::cout<<"SR: "<< fabs(bezierPoints[1].curvature * kc)<< "C: " <<fabs(bezierPoints[1].curvature)<< std::endl;
