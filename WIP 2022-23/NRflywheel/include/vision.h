...
vex::vision::signature RGOAL = vex::vision::signature (3, 5735, 6351, 6043, 1049, 1765, 1407, 5.7, 0);
...
vex::vision Vision16 = vex::vision (vex::PORT16, 70, BGOAL, DISC, RGOAL, SIG_4, SIG_5, SIG_6, SIG_7);
