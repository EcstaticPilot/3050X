...
#include "vex.h"
vex::vision::signature BGOAL = vex::vision::signature (1, -2209, 2317, 54, 2249, 9599, 5924, 1.1, 0);
vex::vision::signature DISC = vex::vision::signature (2, 4527, 5117, 4822, -4065, -3547, -3806, 2.4, 0);
vex::vision::signature RGOAL = vex::vision::signature (3, 2979, 6473, 4726, 1143, 2867, 2005, 1.8, 0);
...
vex::vision Vision16 = vex::vision (vex::PORT16, 150, BGOAL, DISC, RGOAL, SIG_4, SIG_5, SIG_6, SIG_7);
