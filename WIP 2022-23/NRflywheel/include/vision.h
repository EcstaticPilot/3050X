...
#include "vex.h"
vex::vision::signature BGOAL = vex::vision::signature (1, -1855, 2553, 349, 2243, 10039, 6141, 0.9, 0);
vex::vision::signature DISC = vex::vision::signature (2, 0, 0, 0, 0, 0, 0, 3, 0);
vex::vision::signature RGOAL = vex::vision::signature (3, 2685, 6403, 4544, 511, 2759, 1635, 0, 0);
...
vex::vision Vision1 = vex::vision (vex::PORT18, 40, BGOAL, DISC, RGOAL, SNEHA, MORGAN, SIG_6, SIG_7);
