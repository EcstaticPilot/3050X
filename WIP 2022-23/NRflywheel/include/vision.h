...
vex::vision::signature RGOAL = vex::vision::signature (3, 3457, 7047, 5252, -2185, 287, -949, 1.6, 0);
...
vex::vision Vision16 = vex::vision (vex::PORT16, 50, BGOAL, DISC, RGOAL, SIG_4, SIG_5, SIG_6, SIG_7);
