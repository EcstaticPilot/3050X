...
void driver(){
  ...
  while (true){
    ...
    LeftBack.spin(forward, Controller1.Axis3.position()*scale,voltageUnits::mV); 
    LeftFront.spin(forward, Controller1.Axis3.position()*scale,voltageUnits::mV); 
    RightBack.spin(forward, Controller1.Axis2.position()*scale,voltageUnits::mV); 
    RightFront.spin(forward, Controller1.Axis2.position()*scale,voltageUnits::mV);
